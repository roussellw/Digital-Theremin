...
HD_PWD='P:/18summer/engs031/G18/final_31/final_31.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log instrument_shell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source instrument_shell.tcl
