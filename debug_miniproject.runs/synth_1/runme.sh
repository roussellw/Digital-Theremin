...
HD_PWD='P:/18summer/engs031/G18/debug_miniproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_da2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmod_da2.tcl
