...
HD_PWD='P:/18summer/engs031/G18/debug_miniproject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_da2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pmod_da2.tcl -notrace
