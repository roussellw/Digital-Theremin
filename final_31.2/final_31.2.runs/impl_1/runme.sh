...
HD_PWD='P:/18summer/engs031/G18/final_31/final_31.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log instrument_shell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source instrument_shell.tcl -notrace
